...
// - futures contracts are easy to establish `=>` (these futures contracts can used as collateral for loans?)
// - (american) options? calls, puts
// Naivete
// - just queues buyers and sellers such that the chain executes the matching of orders
// - would be great if this could be done in a more privacy-enhancing way...zkkz
//
// Additional Features
// - offchain-workers to orchestrate stop-loss bids
